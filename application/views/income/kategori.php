          ...
          <!-- Modal -->
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    ...
                    <div class="modal-body">
                        <?= form_open('data_akun/tambah', ['method' => 'post']) ?> <!-- Ganti 'kategori/simpan' sesuai controller & method kamu -->
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nama" name="nama_reff" required>
                        </div>
                        <div class="form-group">
            ...
            <table id="datatable" class="table table-bordered table-striped">
              <thead>
                <tr>
                  ...
                  <th class="text-center">Nama Kategoru</th>
